...
export default function EditCountry({
  ...
  const form = useForm<FormSchema>({
    ...
    defaultValues: {
      ...
      active_on_nationalities: country.active_on_nationalities || false,
      active_on_university: country.active_on_university || false,
    },
  });
  ...
  const onSubmit = async (values: FormSchema) => {
    ...
    try {
      ...
      await countriesService.updateCountry(country.id, countryData);
